...
export default function GenerateVideoPage() {
  ...
  /* صفحه از بالا بیاد بالا‌تر */
  .pg {
    padding-top: 8px; /* قبلاً 12 بود، فقط کمی کمترش کردیم */
  }

  /* لوگو: فقط موبایل -> کوچیک و چسبیده بالای صفحه */
  .hdr {
    margin-top: 4px;
    margin-bottom: 4px;
  }
  ...
  .logo {
    max-width: 110px; /* 👈 فقط همین: لوگو کوچیک‌تر تو گوشی */
    height: auto;
  }

  /* تایتل بدون تغییر سایز، فقط فاصله‌ها کم‌تر */
  .title {
    font-size: 30px; /* همون سایز قبلی، دست نزدیم */
    margin-top: 0; /* چسبیده‌تر به لوگو */
    margin-bottom: 8px;/* فاصله کم تا فرم‌ها */
  }

  /* فرم‌ها بیان بالاتر، اون فضای خالی پر بشه */
  .grid {
    margin-top: 0;
    transform: none; /* دیگه پایین نره */
  }
}
      `}</style>
    </main>
