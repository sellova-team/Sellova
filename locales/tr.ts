...
sellerHelp: {
  ...
  // --- Hashtags ---
  hashtags: {
    title: "Hashtag & Açıklama oluştur",
    previewLabel: "Önizleme",
    uploadButton: "Ürün görseli yükle",
    productLabel: "Ürün adı",
    productPlaceholder: 'örn: "Lüks saat", "Gümüş kolye"...',
    platformLabel: "Platform",
    ...
    suggestedHashtagsLabel: "önerilen hashtagler (10)",
    noHashtagsText: 'Henüz hashtag yok — "Hashtag"e tıkla.',
    suggestHashtagsButton: "Hashtag",
    captionLabel: "Açıklama",
    captionPlaceholder: "Açıklama burada görünecek...",
    suggestCaptionButton: "Açıklama",
    generateAllButton: "Hepsini oluştur",
  },
  ...
  sellovaGuide: {
    slides: [
      {
        title: "Sellova’ya hoş geldin",
        subtitle: "Biz üretiriz, sen parıldarsın ✨",
        text: "Sellova modern reklam için hepsi bir arada araçtır.",
        credits: "Ücretsiz erişim",
      },
      {
        title: "Profesyonel görseller",
        subtitle: "AI destekli tasarım",
        text: "Ürün fotoğrafını yükle, biz iyileştirelim.",
        credits: "3 kredi",
      },
      {
        title: "Avatar oluştur",
        subtitle: "Gerçekçi karakterler",
        text: "Marka temsilcini oluştur.",
        credits: "10 kredi",
      },
      {
        title: "Video üret",
        subtitle: "Kısa reklam videoları",
        text: "5–10 saniyelik reklam videoları oluştur.",
        credits: "15 kredi",
      },
      {
        title: "Tanıtım slaytları",
        subtitle: "Satış odaklı içerik",
        text: "Ürünlerini etkili göster.",
        credits: "17 kredi",
      },
      {
        title: "Açıklama & hashtag",
        subtitle: "AI metin üretimi",
        text: "Satış odaklı metinler üret.",
        credits: "3 kredi",
      },
      {
        title: "Marka kimliği",
        subtitle: "Logo entegrasyonu",
        text: "Markanı her yere ekle.",
        credits: "Ücretsiz",
      },
      {
        title: "Analiz",
        subtitle: "Akıllı öneriler",
        text: "Performansını analiz et.",
        credits: "5 kredi",
      },
      {
        title: "Akademi",
        subtitle: "Hızlı öğren",
        text: "Kısa dersler.",
        credits: "Ücretsiz",
      },
      {
